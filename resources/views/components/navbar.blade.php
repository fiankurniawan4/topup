<header class="shadow-lg px-6 py-3 flex items-center justify-between w-full dark:bg-[#0e1726] fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center flex-grow px-6 py-4">
        <a href="#" class="mr-4">
            <svg viewBox="0 0 1024 1024" class="icon" width="32" height="36" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path
                        ...
                        fill="#191919"></path>
                    <path d="M511 497.9m-45.2 0a45.2 45.2 0 1 0 90.4 0 45.2 45.2 0 1 0-90.4 0Z" fill="#D39E33"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="#0F0F0F"></path>
                    <path d="M805.3 243.4m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#0F0F0F"></path>
                    <path d="M805.3 402.2m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#0F0F0F"></path>
                    <path d="M884.7 322.8m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#0F0F0F"></path>
                    <path d="M725.8 322.8m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#0F0F0F"></path>
                </g>
            </svg>
        </a>

        <form class="relative flex-grow mr-2">
            <div class="flex">
                <div
                    class="bg-[#eee] flex justify-center items-center rounded-l-md px-3 font-semibold border border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                ...
                <input id="iconLeft" type="text" placeholder="Cari..." class="form-input rounded-l-none" />
            </div>
        </form>
    </div>

    <div class="flex items-center">
        <label for="menu-toggle" class="lg:hidden block cursor-pointer ml-4">
        ...
        <div class="absolute top-14 right-0 left-0 bg-white shadow-lg hidden" id="mobile-menu">
            <nav>
                <ul class="flex flex-col items-start text-base text-gray-700 p-4 lg:hidden">
                    <li><a class="py-2 block w-full border-b-2 border-transparent hover:border-indigo-400"
                            href="#">Daftar Sekarang</a></li>
                    <li><a class="py-2 block w-full border-b-2 border-transparent hover:border-indigo-400"
                            href="#">Masuk</a></li>
                </ul>
            </nav>
        ...
        <div class="lg:flex md:hidden items-center space-x-4" id="desktop-menu">
            <nav>
                <ul class="flex space-x-4 text-base text-gray-700">
                    <li><a class="btn dark:btn-dark hover:dark:btn-outline-dark" href="#">Daftar Sekarang</a></li>
                    <li><a class="btn dark:btn-dark hover:dark:btn-outline-dark" href="#">Masuk</a></li>
                </ul>
            </nav>
        </div>
    </div>
...
{{-- <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="hidden items-center justify-between py-4 lg:flex">
        <div class="hide-scrollbar flex gap-3 overflow-x-scroll">
            <a href="/">
                <div class="flex w-max items-center gap-1 whitespace-nowrap text-sm font-normal">
